...
**The share card is `site/og.png`, 1200x630, generated by
`tools/make-og-card.mjs`** — headless Chrome over CDP, same shape as the GIF
recorder below, ~0.4 MB. It replaced `icon-512.png` as `og:image`, which is
why every paste of the URL into Facebook, Zalo, X or Slack used to render as a
small square of the letter `b` beside the text.
